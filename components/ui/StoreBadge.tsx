...
function GooglePlayGlyph({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" aria-hidden="true">
      <path d="M3.5 2.3 L14 12 L3.5 21.7 C3.2 21.5 3 21.1 3 20.6 V3.4 C3 2.9 3.2 2.5 3.5 2.3 Z" fill="#34d399" />
      <path d="M3.5 2.3 C3.7 2.2 4 2.2 4.3 2.4 L16.5 9.3 L14 12 Z" fill="#60a5fa" />
      <path d="M3.5 21.7 L14 12 L16.5 14.7 L4.3 21.6 C4 21.8 3.7 21.8 3.5 21.7 Z" fill="#f87171" />
      <path d="M16.5 9.3 L20.4 11.5 C21.2 12 21.2 12 20.4 12.5 L16.5 14.7 L14 12 Z" fill="#fbbf24" />
    </svg>
  );
}
